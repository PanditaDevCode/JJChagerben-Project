...
const SocialContent = ({ title, socialItems }) => {
  return (
    <section
      id="redes"
      className="bg-[#12121c] mt-[-50px] relative xl:relative"
    >
      <div
        className="redes-background bg-BGRedes bg-cover bg-no-repeat 
                            xxs:bg-cover xxs:bg-no-repeat
                            xl:pt-[5em] xl:pb-[5em]"
      >
        <main
          className="redes container pt-[30px] pb-[200px] text-center mt-[20px] 
                                xxs:p-[30px] xxs:pt-1 "
        >
          <h2
            className="font-extrabold p-[10px] z-[9999] mt-[150px] mb-[50px] rounded-[5px] relative hover:scale-[1.02] cursor-pointer hover:text-[#dadada]
                                    xxs:mt-[3em]"
          >
            {title}
          </h2>
          <div
            className="redes-content grid gap-[30px] mb-[-50px] mt-[20px] z-[9999] 
...
const SocialItems = () => {
  ...
  const socialItems = [
    {
      ...
      className: "redes-sociales bg-BGTiktok ",
      divClassName: "tiktok",
    },
    {
      id: 2,
  ...
  return <SocialContent title={title} socialItems={socialItems} />;
};
