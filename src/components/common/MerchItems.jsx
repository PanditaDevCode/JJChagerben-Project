...
const MerchItems = ({
  ...
  return (
    <section className="merch-btc" id="merch">
      <div
        className="merch-container bg-[#1b1b20] pt-[85px] pb-[85px] pl-0 pr-0 items-center justify-center flex relative gap-[100px] 
                            xxs:items-center xxs:content-center xxs:text-center xxs:flex-col
                            md:flex md:flex-row"
      >
        <div
          className="merch relative w-[350px] h-[500px] bg-[#232323] overflow-hidden rounded-[20px]
        ...
        >
          ...
          <div className="merch-content absolute bottom-0 w-full h-[100px] text-center z-90 ">
            <h2 className="relative font-extrabold tracking-[1px] text-[#111111] text-[30px] xxs:text-[25px] ">
              {Title1}
            </h2>
            <div className="size flex justify-center align-center pt-[8px] pb-[8px] pl-[20px] pr-[20px] opacity-0 invisible ">
              ...
              <ul className="size-list list-none p-0 m-0 ml-[10px] flex ">
                {sizeOptions.map((size) => (
                  ...
                  >
                    <span className="w-[35px] h-[25px] text-center grid place-content-center bg-[#111] text-white mt-0 mb-0 ml-[5px] mr-[5px] text-[14px] font-semibold rounded-[4px] z-10 cursor-pointer hover:cursor-pointer hover:scale-[1.05] ">
                      {size.label}
                    </span>
                  </li>
                ))}
            ...
            <div className="info-merch">
              ...
              <h3 className="text-white font-extrabold mb-[10px] ">
                {PriceH3}
              </h3>
              <a
                href={Link}
