...
const AboutItems = ({ ImageSrc, VideoSrc, Title }) => {
    return (
        <section id="about-me" className="about-me container pt-[150px] pb-[150px] flex flex-col items-center relative
            ...
            <div className="about-me-img xl:basis-[30%] flex justify-center
                    xxs:m-[30px] xxs:w-[18em]">
                <img src={ImageSrc} alt={`Imagen de ${Title}`} className="w-[350px] h-[350px] rounded-full object-cover xxs:h-[18em] xl:h-[21em] " />
            </div>
