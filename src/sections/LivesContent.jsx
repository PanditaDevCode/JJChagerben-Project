...
const LivesItems = ({ TitleH1, TitleH2, Link1, Link2, Link3, ImageSrc }) => {
  return (
    <section
      id="lives"
      className="lives container pt-[200px] pb-[200px] pl-0 pr-0 flex items-center bg-[#1b1b20] ml-0 mr-0 
      ...
      <div className="flex flex-col xl:flex-row">
        ...
        >
          <div className="live-txt1 ml-[50px] xxs:content-center xxs:mr-[30px] ">
            <h1>
              <span className="intro text-black font-extrabold ">
                {TitleH1}
              </span>
            </h1>
            <h2>
              <span className=" text-black font-extrabold">{TitleH2}</span>
            </h2>
            <ul className="mb-[25px] ">
              <li className="text-white">
                - Hora de los directos:{" "}
                <span className=" text-black font-extrabold">20:00 PM</span>
              </li>
              <li className="text-white">
                - Zona Horaria:{" "}
                <span className=" text-black font-extrabold">UTC - 05:00</span>
              </li>
              <li className="text-white">
                - Directos en mis redes sociales:{" "}
            ...
            <div
              className="btn-container flex flex-wrap 
            ...
            >
              <div className="xxs:flex">
                <a
                  ...
                  className="btn-1 bg-[#12121cd2] text-[#fdfeff] pt-[11px] pb-[11px] pl-[35px] pr-[35px] z-2 font-extrabold rounded-[5px] mt-0 mb-0 ml-[15px] mr-[15px] xxs:m-[10px]"
                >
                  YouTube
                </a>
                <a
        ...
        <div
          className="lives-img w-[80%] basis-[45%] mt-[-16em] mb-0 ml-0 mr-0 
        ...
        >
          <img
            src={ImageSrc}
            alt="Imagen de directos en vivo"
