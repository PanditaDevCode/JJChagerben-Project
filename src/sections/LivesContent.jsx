        ...
        <section className="lives container pt-[200px] pb-[200px] pl-0 pr-0 flex items-center bg-[#1b1b20] ml-0 mr-0 
            ...
            <div id="lives">
                <div className="lives-txt basis-[55%] m-0 text-[18px]
                    ...
                    <div className="live-txt1 ml-[50px] xxs:content-center xxs:mr-[30px] ">
                        ...
                        <div className="btn-container flex flex-wrap 
                                        xxs:flex xxs:flex-col xxs:items-center xxs:justify-betwen">
                ...
                <div className="lives-img w-[80%] basis-[45%] mt-[-16em] mb-0 ml-[48em] mr-0 
                                ...
                                md:ml-[4em]">
                    <img src={ImageSrc} alt="Imagen de directos en vivo" className="w-[500px] rounded-[20px] xxs:items-center xxs:content-center xxs:w-[280px] s:h-[15em] s:w-[100em] md:w-[35em] md:h-[18em] " />
                </div>
            </div>
        </section>
    );
